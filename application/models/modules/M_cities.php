...
class M_cities extends CI_Model {
	...
	public function __construct() {
		...
		if (!isset($this->data_or )) 
		   $this->data_or = new stdClass();
	...
	public function set_or($tag,$value){
		$this->data_or->$tag = $value;
		return $this;
	}
	...
	public function sets_or($array) {

		foreach ($array as $k => $v) {
			if(isset($this->data_or->$k)) {
				$this->data_or->$k = $v;
			}
			else{
				$this->data_or->$k =  $v;
	...
	public function get() {
		...
		if($this->data_or){
			$this->db->or_where((array)$this->data_or);
		}
